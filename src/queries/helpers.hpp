...
inline __m128i ge_16u16(const uint16_t *a, __m128i b) {
  __m128i a_0_8u16 = _mm_lddqu_si128((__m128i *)a);
  __m128i a_1_8u16 = _mm_lddqu_si128((__m128i *)(a + 8));
  __m128i a_mask_ge_0_8u16 = _mm_or_si128(_mm_cmpgt_epi16(a_0_8u16, b), _mm_cmpeq_epi16(a_0_8u16, b));
  __m128i a_mask_ge_1_8u16 = _mm_or_si128(_mm_cmpgt_epi16(a_1_8u16, b), _mm_cmpeq_epi16(a_1_8u16, b));
...
inline __m128i le_16u16(const uint16_t *a, __m128i b) {
  __m128i a_0_8u16 = _mm_lddqu_si128((__m128i *)a);
  __m128i a_1_8u16 = _mm_lddqu_si128((__m128i *)(a + 8));
  __m128i a_mask_le_0_8u16 = _mm_or_si128(_mm_cmplt_epi16(a_0_8u16, b), _mm_cmpeq_epi16(a_0_8u16, b));
  __m128i a_mask_le_1_8u16 = _mm_or_si128(_mm_cmplt_epi16(a_1_8u16, b), _mm_cmpeq_epi16(a_1_8u16, b));
