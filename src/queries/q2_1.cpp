...
void q2_1_agg_chunk(const WideTable &t, size_t begin, size_t end, std::vector<uint16_t> &acc) {
...
uint16_t q2_1_sse_filter_chunk(const WideTable &t, size_t i) {
  ...
  static __m128i k_mfgr_12_16u8 = _mm_set1_epi8((char)k_mfgr_12());
  static __m128i k_america_16u8 = _mm_set1_epi8((char)k_america());

  // Compute p_category = 'MFGR#12'.
  __m128i p_category_16u8 = _mm_lddqu_si128((__m128i *)&t.p_category[i]);
  __m128i mask_16u8 = _mm_cmpeq_epi8(p_category_16u8, k_mfgr_12_16u8);

  // Compute s_region = 'AMERICA'.
  __m128i s_region_16u8 = _mm_lddqu_si128((__m128i *)&t.s_region[i]);
  mask_16u8 = _mm_and_si128(mask_16u8, _mm_cmpeq_epi8(s_region_16u8, k_america_16u8));
