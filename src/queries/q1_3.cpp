...
uint32_t Q1_3::scalar(const WideTable &t) {
...
uint32_t Q1_3::sse(const WideTable &t) {
...
void Q1_3::filter(const WideTable &t, uint32_t *b) {
...
uint32_t Q1_3::agg(const WideTable &t, const uint32_t *b) { return q1_agg(t, b); }
